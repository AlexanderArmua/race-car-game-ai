...
class CarRNA:
    ...
    def get_result(self, inputs: List[float]) -> float:
        ...
        value_l1_n0: float = activation_function(self.weight_l0_n0_to_l1_n0 * inputs[0] + self.weight_l0_n1_to_l1_n0 * inputs[1] + self.weight_l0_n2_to_l1_n0 * inputs[2])
        value_l1_n1: float = activation_function(self.weight_l0_n0_to_l1_n1 * inputs[0] + self.weight_l0_n1_to_l1_n1 * inputs[1] + self.weight_l0_n2_to_l1_n1 * inputs[2])
        value_l1_n2: float = activation_function(self.weight_l0_n0_to_l1_n2 * inputs[0] + self.weight_l0_n1_to_l1_n2 * inputs[1] + self.weight_l0_n2_to_l1_n2 * inputs[2])

        value_l2_n0: float = activation_function(self.weight_l1_n0_to_l2_n0 * value_l1_n0 + self.weight_l1_n1_to_l2_n0 * value_l1_n1 + self.weight_l1_n2_to_l2_n0 * value_l1_n2)
